...
/*0x01cc*/ uint8_t                  Unknown_0x1cc[0x14];
/*0x01e0*/ int64_t                  HPCurrent;
/*0x01e8*/ uint8_t                  Unknown_0x1e8[0x2c];
/*0x0214*/ int                      EnduranceMax;
/*0x0218*/ uint8_t                  Unknown_0x218[0x20];
/*0x0238*/ int64_t                  HPMax;
/*0x0240*/ uint8_t                  Unknown_0x240[0x4];
/*0x0244*/ int                      Buyer;
/*0x0248*/ uint8_t                  StandState;                         // 0x64=stand 0x6e=sit 0x73=duck
/*0x0249*/ uint8_t                  Unknown_0x249[0x3];
/*0x024c*/ LaunchSpellData          CastingData;                        // 0x24c..0x290 (size 0x44)
/*0x0290*/ uint8_t                  Unknown_0x290[0x4];
/*0x0294*/ uint8_t                  bOfflineMode;
/*0x0295*/ uint8_t                  Unknown_0x295[0x3];
/*0x0298*/ int                      GuildStatus;                        // GuildRank/status (SpawnAppearance GuildRank case)
/*0x029c*/ uint8_t                  Unknown_0x29c[0x1c];
/*0x02b8*/ int                      Anon;                               // bit0=Anonymous bit1=Roleplaying
/*0x02bc*/ uint8_t                  Unknown_0x2bc[0xc];
/*0x02c8*/ int                      EnduranceCurrent;
/*0x02cc*/ uint8_t                  Unknown_0x2cc[0x90];
/*0x035c*/ EqItemGuid               realEstateItemGuid;                 // 0x35c..0x36e (size 0x12)
/*0x036e*/ char                     Title[0x80];
/*0x03ee*/ uint8_t                  Unknown_0x3ee[0xe];
/*0x03fc*/ uint8_t                  LFG;
/*0x03fd*/ uint8_t                  Level;
/*0x03fe*/ uint8_t                  Unknown_0x3fe[0x2];
/*0x0400*/ int                      PetID;                              // -1 = no pet
/*0x0404*/ uint8_t                  Unknown_0x404[0x4];
/*0x0408*/ int                      Deity;
/*0x040c*/ uint8_t                  Unknown_0x40c[0x44];
/*0x0450*/ int                      AFK;
/*0x0454*/ uint8_t                  Unknown_0x454[0xc];
/*0x0460*/ int                      ManaCurrent;
/*0x0464*/ uint8_t                  Unknown_0x464[0xd];
/*0x0471*/ char                     Suffix[0x80];
/*0x04f1*/ uint8_t                  Unknown_0x4f1[0x7];
/*0x04f8*/ PcClient*                pPcClient;                          // pCharacter accessor base (GetPcClient)
/*0x0500*/ uint8_t                  Unknown_0x500[0x4];
/*0x0504*/ unsigned int             SpellGemETA[NUM_SPELL_GEMS + 1];    // [15]; 0x504..0x540, last = innate slot
/*0x0540*/ uint8_t                  Unknown_0x540[0x10];
/*0x0550*/ int                      Trader;
/*0x0554*/ uint8_t                  Unknown_0x554[0x8];
/*0x055c*/ uint8_t                  PvPFlag;
/*0x055d*/ uint8_t                  Unknown_0x55d[0x27];
/*0x0584*/ uint8_t                  Unknown_0x584[0x8];
/*0x058c*/ uint8_t                  Unknown_0x58c[0x8];
/*0x0594*/ uint8_t                  Unknown_0x594[0x8];
/*0x059c*/ uint8_t                  Unknown_0x59c[0x8];
/*0x05a4*/ uint8_t                  Unknown_0x5a4[0x8];
/*0x05ac*/ uint8_t                  Unknown_0x5ac[0x8];
/*0x05b4*/ uint8_t                  Unknown_0x5b4[0x48];
/*0x05fc*/ int                      ManaMax;
/*0x0600*/ uint8_t                  Unknown_0x600[0x10];
/*0x0610*/ unsigned int             SpellCooldownETA;                   // global gem/spell recast lockout timestamp
/*0x0614*/ uint8_t                  Unknown_0x614[0x18];
/*0x062c*/ uint8_t                  Unknown_0x62c[0x10];
// @end: PlayerZoneClient Members

/*0x063c*/ uint8_t                  Unknown_0x63c[0x20];                 // pad before MovementStats (0x65c)
/*0x065c*/ TCircularBuffer<SDoCollisionMovementStats, MAX_MOVEMENT_STATS> MovementStats;
/*0x0f74*/ uint8_t                  Unknown_0xf74[0x4];                 // align pad after MovementStats
...
/*0x0fcc*/ uint8_t                  Unknown_0xfcc[0x4];                 // +4 physics-record growth vs prior layout
...
/*0x1278*/
	...
	EQZoneIndex get_Zone() const { return 0; }
	__declspec(property(get = get_Zone)) EQZoneIndex Zone;
	bool get_GM() const { return false; }
	__declspec(property(get = get_GM)) bool GM;
	int64_t get_GuildID() const { return -1; }
	__declspec(property(get = get_GuildID)) int64_t GuildID;
	unsigned int get_MasterID() const { return 0; }
	__declspec(property(get = get_MasterID)) unsigned int MasterID;
	bool get_Sneak() const { return false; }
	__declspec(property(get = get_Sneak)) bool Sneak;
	bool get_Linkdead() const { return false; }
	__declspec(property(get = get_Linkdead)) bool Linkdead;
	bool get_Mercenary() const { return false; }
	__declspec(property(get = get_Mercenary)) bool Mercenary;
	bool get_bSummoned() const { return false; }
	__declspec(property(get = get_bSummoned)) bool bSummoned;
	bool get_bTempPet() const { return false; }
	__declspec(property(get = get_bTempPet)) bool bTempPet;
	int get_HideMode() const { return 0; }
	__declspec(property(get = get_HideMode)) int HideMode;
	unsigned int get_RespawnTimer() const { return 0; }
	__declspec(property(get = get_RespawnTimer)) unsigned int RespawnTimer;
	unsigned int get_CorpseDragCount() const { return 0; }
	__declspec(property(get = get_CorpseDragCount)) unsigned int CorpseDragCount;
	unsigned int get_HoldingAnimation() const { return 0; }
	__declspec(property(get = get_HoldingAnimation)) unsigned int HoldingAnimation;
	uint8_t get_Light() const { return 0; }
	__declspec(property(get = get_Light)) uint8_t Light;
	uint8_t get_GMRank() const { return 0; }
	__declspec(property(get = get_GMRank)) uint8_t GMRank;
	unsigned int get_InPvPArea() const { return 0; }
	__declspec(property(get = get_InPvPArea)) unsigned int InPvPArea;
	uint8_t get_Blind() const { return 0; }
	__declspec(property(get = get_Blind)) uint8_t Blind;
	bool get_berserker() const { return false; }
	__declspec(property(get = get_berserker)) bool berserker;
	float get_GetMeleeRangeVar1() const { return 1.0f; }
	__declspec(property(get = get_GetMeleeRangeVar1)) float GetMeleeRangeVar1;
	void* get_pTouchingSwitch() const { return nullptr; }
	__declspec(property(get = get_pTouchingSwitch)) void* pTouchingSwitch;
	const unsigned int* get_CombatSkillTicks() const { static const unsigned int z[2] = { 0, 0 }; return z; }
	__declspec(property(get = get_CombatSkillTicks)) const unsigned int* CombatSkillTicks;
};
...
constexpr size_t PlayerClient_size = 0x20D8; // @sizeof(PlayerClient) :: 2026-05-20 (live)
...
public:
	...
	inline int64_t GetCurrentHP() const { return HPCurrent; }
	inline int64_t GetMaxHP() const { return HPMax; }
