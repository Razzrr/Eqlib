...
constexpr size_t CXWnd_size = 0x268; // @sizeof(CXWnd) :: 2026-05-19 (live)
...
/*0x160*/ CScreenPieceTemplate*  TitlePiece2;
/*0x168*/ uint32_t               XMLIndex;
/*0x16c*/ uint32_t               Unknown0x16c;
/*0x170*/ CScreenPieceTemplate*  TitlePiece;
...
constexpr size_t CSidlScreenWnd_size = 0x2D0; // @sizeof(CSidlScreenWnd) :: 2026-05-19 (live)
